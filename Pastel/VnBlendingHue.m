...
NSString *const kVnBlendingHueFragmentShaderString = SHADER_STRING
(
...
@implementation VnBlendingHue

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kVnBlendingHueFragmentShaderString]))
    {
		return nil;
    }
