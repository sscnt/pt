...
NSString *const kVnBlendingSaturationFragmentShaderString = SHADER_STRING
(
 ...
 void main()
 {
     ...
     mediump float weight = baseHsv.y;
     weight = weight * weight;
     baseHsv.y = overlayHsv.y * weight + (1.0 - weight) * baseHsv.y;
...
@implementation VnBlendingSaturation

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kVnBlendingSaturationFragmentShaderString]))
    {
		return nil;
    }
