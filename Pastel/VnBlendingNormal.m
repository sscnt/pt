...
NSString *const kVnBlendingNormalFragmentShaderString = SHADER_STRING
(
...
@implementation VnBlendingNormal

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kVnBlendingNormalFragmentShaderString]))
    {
		return nil;
    }
